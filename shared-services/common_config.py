...
class CommonConfigManager:
    ...
    def _apply_env_overrides(self, config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        env_mappings = {
            ...
            "DEBUG": "debug",
            # Port mappings (only active services)
            "DASHBOARD_PORT": "ports.dashboard_service",
            "DATA_PROCESSING_PORT": "ports.data_processing_service",
            "DATABASE_PORT": "ports.database_service",
        }
