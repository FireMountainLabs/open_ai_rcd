...
- **Data Extraction**: Extracts data from Excel files (risks, controls, questions, definitions, capabilities)
- **Database Generation**: Creates a normalized SQLite database (`aiml_data.db`)
- **Relationship Mapping**: Builds mappings between risks, controls, questions, and capabilities
...
- **`extractors/`**: Specialized extractors for different data types
  ...
  - `question_extractor.py`: Question data extraction
...
- **Required Columns**: Question Number, Question Text, Category, Topic
- **Configuration**: `data_sources.questions` in `default_config.yaml`
- **Special**: Processes all sheets in the file
...
- **Required Columns**: Capability, Domain, Definition, Controls
- **Configuration**: `data_sources.capabilities` in `default_config.yaml`
...
- **`questions`**: Interview questions and categorization
  - `id`, `text`, `category`, `topic`, `managing_role`, `created_at`, `updated_at`
- **`definitions`**: AI/ML terminology definitions
  - `id`, `title`, `description`, `category`, `source`, `created_at`, `updated_at`
- **`capabilities`**: Security capabilities
  - `id`, `capability`, `capability_type`, `domain`, `definition`, `created_at`, `updated_at`
...
- **`processing_metadata`**: Processing statistics and timestamps
  - `processing_date`, `total_risks`, `total_controls`, `total_questions`, `status`
