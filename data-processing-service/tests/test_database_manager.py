...
class TestDatabaseManager:
    ...
    def test_insert_processing_metadata(self, database_manager):
        ...
        # total_questions, total_risk_control_mappings,
        # total_question_risk_mappings, total_question_control_mappings,
        # processing_status
        assert result[2] == "v1.0"  # data_version
        assert result[3] == 10      # total_risks
        assert result[4] == 5       # total_controls
        assert result[5] == 15      # total_questions
        assert result[6] == 20      # total_risk_control_mappings
        assert result[9] == "completed"  # processing_status
