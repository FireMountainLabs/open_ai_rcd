...
class DatabaseManager:
    ...
    def create_tables(self) -> None:
        ...
        # Create capability-control mapping table
        cursor.execute(
            """
            CREATE TABLE IF NOT EXISTS capability_control_mapping (
                id INTEGER PRIMARY KEY AUTOINCREMENT,
        ...
        cursor.execute(
            ...
            CREATE TABLE IF NOT EXISTS processing_metadata (
                ...
                total_capability_control_mappings INTEGER,
    ...
    def insert_processing_metadata(
        ...
        total_capability_control_mappings: int = 0,
        ...
        Args:
            ...
            total_capabilities: Total number of capabilities processed
            ...
            total_capability_control_mappings: Total number of capability-control mappings
        ...
        try:
            cursor.execute(
                ...
                (data_version, total_risks, total_controls, total_questions, total_capabilities,
                 total_risk_control_mappings, total_question_risk_mappings,
                 total_question_control_mappings, total_capability_control_mappings, processing_status)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            """,
                (
                    data_version,
                    ...
                    total_capability_control_mappings,
                    processing_status,
                ),
            )
