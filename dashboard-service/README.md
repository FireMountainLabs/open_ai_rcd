...
- **`routes/`**: Blueprint modules for API endpoints
  ...
  - `capability_scenarios.py`: Capability scenario analysis endpoints
...
- `GET /api/questions/summary` - Questions summary
- `GET /api/question/{question_id}` - Question details
- `GET /api/definitions` - List definitions
- `GET /api/capabilities` - List capabilities
- `GET /api/capabilities/{capability_id}` - Capability details
- `GET /api/capability-tree` - Capability tree with controls and risks
...
- `GET /api/managing-roles` - Distinct managing roles from questions

### Capability Scenarios

- `GET /api/capability-scenarios` - Capability scenario analysis endpoints
